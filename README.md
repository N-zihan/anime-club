...
| 改进 | 说明 |
|------|------|
| 添加徽章（Badge） | 让 README 更有视觉冲击力，展示项目状态 |
| 补充萌战系统说明 | 你花了最多精力的功能，值得被看到 |
| 补充权限体系说明 | 站长/运营双角色设计是亮点 |
| 补充测试覆盖说明 | 77 个测试是你的专业证明 |
| 添加测试运行命令 | 别人 clone 后能直接跑测试 |
| 优化环境变量说明 | 删除不存在的 `ADMIN_PASSWORD`，补充注释 |
| 添加后续计划任务清单 | 展示项目还在持续进化 |
...
```bash
git add README.md
git commit -m "docs: 优化 README，补充测试覆盖和萌战系统说明"
git push